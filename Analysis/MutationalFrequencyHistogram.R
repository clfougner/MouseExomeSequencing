...
p2<-mutations+geom_bar(width=0.85, stat='identity', position = position_dodge(width=0.85)) +
  theme(axis.text.x=element_text(size=12, angle=90, hjust=1, vjust = 0.5, face = "italic"),
