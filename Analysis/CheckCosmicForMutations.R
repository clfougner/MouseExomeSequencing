# NOTE: This script doesn't deal with amino acid changes to * - these must be manually checked.
...
# 
# write.table(x=outputDataFrame, file="HomologsWithCosmicInfo.txt", sep="\t", quote = FALSE)