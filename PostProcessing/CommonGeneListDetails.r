...
#########################################################################
S123_14_6_df<-data.frame(S123_14_6_table$V10, row.names = S123_14_6_table$V5, stringsAsFactors = FALSE)
S131_14_9_df<-data.frame(S131_14_9_table$V10, row.names = S131_14_9_table$V5, stringsAsFactors = FALSE)
S132_14_5_df<-data.frame(S132_14_5_table$V10, row.names = S132_14_5_table$V5, stringsAsFactors = FALSE)
S153_14_2_df<-data.frame(S153_14_2_table$V10, row.names = S153_14_2_table$V5, stringsAsFactors = FALSE)
S159_14_2_df<-data.frame(S159_14_2_table$V10, row.names = S159_14_2_table$V5, stringsAsFactors = FALSE)
S159_14_8_df<-data.frame(S159_14_8_table$V10, row.names = S159_14_8_table$V5, stringsAsFactors = FALSE)
S160_14_2_df<-data.frame(S160_14_2_table$V10, row.names = S160_14_2_table$V5, stringsAsFactors = FALSE)
S176_14_2_df<-data.frame(S176_14_2_table$V10, row.names = S176_14_2_table$V5, stringsAsFactors = FALSE)
S187_14_1_df<-data.frame(S187_14_1_table$V10, row.names = S187_14_1_table$V5, stringsAsFactors = FALSE)
S189_14_2_df<-data.frame(S189_14_2_table$V10, row.names = S189_14_2_table$V5, stringsAsFactors = FALSE)
S189_14_4_df<-data.frame(S189_14_4_table$V10, row.names = S189_14_4_table$V5, stringsAsFactors = FALSE)
S400_15_2_df<-data.frame(S400_15_2_table$V10, row.names = S400_15_2_table$V5, stringsAsFactors = FALSE)
S400_15_7_df<-data.frame(S400_15_7_table$V10, row.names = S400_15_7_table$V5, stringsAsFactors = FALSE)
S401_15_2_df<-data.frame(S401_15_2_table$V10, row.names = S401_15_2_table$V5, stringsAsFactors = FALSE)
S412_15_2_df<-data.frame(S412_15_2_table$V10, row.names = S412_15_2_table$V5, stringsAsFactors = FALSE)
S416_15_13_df<-data.frame(S416_15_13_table$V10, row.names = S416_15_13_table$V5, stringsAsFactors = FALSE)
S416_15_2_df<-data.frame(S416_15_2_table$V10, row.names = S416_15_2_table$V5, stringsAsFactors = FALSE)
S422_15_2_df<-data.frame(S422_15_2_table$V10, row.names = S422_15_2_table$V5, stringsAsFactors = FALSE)
...
## Print table
###################################################################
write.table(ordered, file='/Volumes/christian/DMBA-induced/Output/OrderedListByEffect.txt', quote = FALSE, sep='\t')
