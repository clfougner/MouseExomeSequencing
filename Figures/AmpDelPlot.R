...
print(chart)
ggsave("/Users/christianfougner/Documents/Forskerlinja/DMBA-indusert/Sequencing/Output/AnalysisResults_w50k/DMBAAmpDels.png", chart, width = 8, height = 15, dpi = 300)
